    ...
    <div class="sidebar-menu">
        <ul class="menu">
            ...
            <li
                ...
                <a href="<?= route_to('beranda.dosen') ?>" class='sidebar-link'>
                    <i class="bi bi-grid-fill"></i>
                    <span>Beranda</span>
                </a>
            </li>
            <li
                class="sidebar-item <?php if($title == "Sesi Asesmen"): echo 'active'; endif; ?>">
                <a href="<?= route_to('hal.sesi_ujian') ?>" class='sidebar-link'>
                    <i class="fa-solid fa-laptop-file"></i>
                    <span>Sesi Asesmen</span>
                </a>
            </li>
            <li
                class="sidebar-item <?php if($title == "Bank Soal"): echo 'active'; endif; ?>">
                <a href="<?= route_to('hal.soal') ?>" class='sidebar-link'>
            ...
            <li
                class="sidebar-item <?php if($title == "Rekapitulasi"): echo 'active'; endif; ?>">
                <a href="<?= route_to('hal.rekapitulasi') ?>" class='sidebar-link'>
            ...
            <div class="d-flex justify-content-between">
                <div class="page-heading">
                    ...
                    <?php if($title === 'Beranda'): ?>
                        <h5>Selamat datang <?= $dosen['nama_lengkap'] ?>!</h5>
                    <?php endif; ?>
                </div> 
                <div class="page-heading d-flex align-items-center">
                    <div class="dropdown d-block d-md-none ">
                        <button class="dropdown-toggle" style="border:0px;background-color:transparent;" type="button" id="header_dosen" data-bs-toggle="dropdown" aria-expanded="false">
                            <div class="avatar avatar-lg">
                                <img src="<?= base_url('/assets/compiled/jpg/5.jpg') ?>">
                            </div>
                        </button>
                        <ul class="dropdown-menu" aria-labelledby="header_dosen">
                            <li><font class="dropdown-item"><?= $dosen['nama_lengkap'] ?></font></li>
                        </ul>
                    </div>
                    <div class="d-none d-md-block">
                        <font class="fw-bold me-2"><?= $dosen['nama_lengkap'] ?></font>
